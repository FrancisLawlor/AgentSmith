...
public class Player extends ASTRAClass {
	public Player() {
		...
		addRule(new Rule(
			"agents.Player", new int[] {15,9,15,36},
			new GoalEvent('+',
				new Goal(
			...
			Predicate.TRUE,
			new Block(
				"agents.Player", new int[] {15,35,18,5},
				new Statement[] {
					new ModuleCall("console",
						"agents.Player", new int[] {16,8,16,33},
		...
		addRule(new Rule(
			"agents.Player", new int[] {20,9,20,20},
			new GoalEvent('+',
				new Goal(
					new Predicate("setup", new Term[] {})
				)
			...
			Predicate.TRUE,
			new Block(
				"agents.Player", new int[] {20,19,24,5},
				new Statement[] {
